...
class LoadTodayIntake extends StatefulWidget {
  const LoadTodayIntake();

  @override
  State<LoadTodayIntake> createState() => LoadTodayIntakeState();
}

class LoadTodayIntakeState extends State<LoadTodayIntake> {
  int? idPengguna;
  double target = 0.0;
